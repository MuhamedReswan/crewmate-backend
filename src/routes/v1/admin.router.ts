...
const adminServiceBoyController = container.resolve<IAdminServiceBoyController>(
  "IAdminServiceBoyController"
);

router.use(authMiddleware);

const adminUsermanagementController = container.resolve<IAdminUserManagementController>(
  "IAdminUserManagementController"
);

router.get(
  "/:userType/pending-verification",
