...
import { IAdminVendorService } from "../../interfaces/admin/IAdminVendor.service";
...
// try {
//    const allPendingVerification  = await this._vendorRepository.loadAllPendingVerification()
