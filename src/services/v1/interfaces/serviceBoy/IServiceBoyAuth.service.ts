...
export interface IServiceBoyAuthService {
    ...
    verifyOTP(email:string, otp:string, oldRefreshToken?: string): Promise<ServiceBoyLoginResponse | void>
    serviceBoyLogin(email:string, password:string, oldRefreshToken?: string): Promise<ServiceBoyLoginResponse>
    ...
    googleAuth(data: GoogleLogin, oldRefreshToken?: string): Promise <ServiceBoyLoginResponse | undefined>
